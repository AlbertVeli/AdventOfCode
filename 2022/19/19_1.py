...
verybest = list(sorted(best.items(), key = lambda item: item[1], reverse = True))[0]
print(f'Blueprint {verybest[0]} is best with {verybest[1]} geodes')
qualitylevels = []
for i in range(1, len(best) + 1):
    qualitylevels.append(i * best[i])
print('Part 1:', sum(qualitylevels))
