...
for line in lines:
    ...
    len_boundary2 += length

# Simplified shoelace formula
def shoelace(corners, len_boundary):
    area = 0
    length = len(corners)
...
print('Part 1:', shoelace(corners1, len_boundary1))
print('Part 2:', shoelace(corners2, len_boundary2))
